        ...
        def on_success(result: tuple[ExportArtifacts, GAMSRunResult]) -> None:
            ...
            self._populate_results_panel(
                [
                    ...
                    ("Reconciliation catalog", str(artifacts.reconciliation_catalog_csv)),
                    ("Semantic coordination catalog", str(artifacts.semantic_coordination_csv)),
                    ...
                    (
                        ...
                        str(artifacts.generated_reconciliation_helper_include),
                    ),
                    (
                    ...
                    (
                        "Generated reconciliation example",
                        str(artifacts.generated_reconciliation_example_model),
                    ),
            ...
            messagebox.showinfo(
                ...
                f"{structured_lines}\n\n"
                "Generic, semantic, structured, and reconciliation outputs are summarized in the generated catalogs and helper includes.\n\n"
                f"GDX data: {run_result.gdx_file}\n"
                f"Import job folder: {artifacts.job_directory}\n"
                f"Manifest: {artifacts.manifest_csv}\n"
                f"Reconciliation catalog: {artifacts.reconciliation_catalog_csv}\n"
                f"Semantic coordination catalog: {artifacts.semantic_coordination_csv}\n"
                ...
                f"Reconciliation helper include: {artifacts.generated_reconciliation_helper_include}\n"
                ...
                f"Reconciliation example: {artifacts.generated_reconciliation_example_model}\n"
